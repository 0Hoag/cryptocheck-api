...
- [ ] Gate private group creation and enhanced scanner quotas/depth with entitlement checks.
  ...
  - [x] Authenticated scanner quota is enforced from persisted server-side history: Free 20 successful scans/day; Premium 200/day. (scanner package + full Go suite passed)
