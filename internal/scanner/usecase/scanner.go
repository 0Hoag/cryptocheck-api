...
func (uc ScannerUC) FindCandidates(ctx context.Context, input scanDomain.FindCandidatesInput) ([]scanDomain.TokenCandidate, error) {
	...
	for _, asset := range assets {
		candidates = append(candidates, scanDomain.TokenCandidate{
			...
			LiquidityUSD: asset.LiquidityUSD, VolumeH24: asset.VolumeH24, PriceUSD: asset.PriceUSD, ImageURL: asset.ImageURL, ContractScanSupported: asset.ContractScanSupported,
...
func (uc ScannerUC) scanSolanaMint(ctx context.Context, asset dexscreener.Asset, language string) (scanDomain.ScanTokenOutput, error) {
	...
	return scanDomain.ScanTokenOutput{
		...
		ScoreAvailable: true, TrustScore: score, LiquidityUSD: asset.LiquidityUSD, VolumeH24: asset.VolumeH24, PriceUSD: asset.PriceUSD, ImageURL: asset.ImageURL,
